...
TEACHER
The teacher is Mr Saurine. No room, email, contact details or teaching-style information has been supplied. Never invent missing teacher details.
`;
...
export function fallbackAnswer(question = "") {
  ...
  const directAnswer = directCourseAnswer(question);
